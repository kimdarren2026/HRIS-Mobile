...
<div class="w-full max-w-[390px] min-h-screen md:min-h-0 md:h-[844px] md:rounded-[2rem] md:shadow-2xl
    ...
    <div class="flex-1 px-8 pt-2 flex flex-col gap-4 w-full">
        <form action="{{ route('login.attempt') }}" method="POST" class="flex flex-col gap-4 w-full" novalidate>
            ...
            <!-- Google Workspace button — disabled (no OAuth route yet) -->
            {{-- TODO: implement Google OAuth route then replace with an <a> linking to it --}}
            <button type="button" disabled
                    ...
                    title="Google Workspace login — segera hadir">
                <svg class="w-4 h-4 opacity-50 shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                     aria-hidden="true">
