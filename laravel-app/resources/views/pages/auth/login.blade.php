            ...
            <div class="flex flex-col gap-2">
                <a href="{{ route('auth.google.redirect') }}"
                   ...
                   style="border-color:#e2e8f0;background:#fff;color:#334155;">
                    ...
                    Masuk dengan akun Google institusi
                </a>
                <p class="text-center text-xs" style="color:#64748b;">
                    Gunakan login Google jika akun Anda sudah didaftarkan di HRIS oleh Admin HR.
                </p>
            </div>

            <div class="flex items-center gap-3">
                <div class="flex-1 h-px" style="background:#e2e8f0;"></div>
                <span style="font-size:11px;color:#94a3b8;font-weight:500;">atau masuk dengan email dan kata sandi</span>
                <div class="flex-1 h-px" style="background:#e2e8f0;"></div>
            </div>
