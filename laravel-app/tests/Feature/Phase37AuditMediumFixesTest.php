...
class Phase37AuditMediumFixesTest extends TestCase
{
    ...
    {
        $this->actingAs($this->employeeUser)
            ->post('/attendance/check-out', ['lat' => -6.2, 'lng' => 106.8, 'accuracy' => 5, 'check_out_work_result' => 'Pekerjaan hari ini selesai dengan baik.'])
    ...
    public function test_checkout_records_time_and_coords(): void
    {
        ...
        $this->actingAs($this->employeeUser)
            ->post('/attendance/check-out', ['lat' => -6.2001, 'lng' => 106.8001, 'accuracy' => 5, 'check_out_work_result' => 'Pekerjaan hari ini selesai dengan baik.'])
