...
<p class="font-headline-lg text-headline-lg text-on-background">08:00 AM</p>
</div>
...
<div class="bg-surface-container-lowest rounded-xl p-unit-md shadow-sm border border-border flex flex-col justify-between">
<div class="flex justify-between items-center mb-2">
<span class="material-symbols-outlined text-secondary text-[24px]">event_note</span>
<span class="bg-surface-variant text-on-surface-variant px-2 py-0.5 rounded text-[10px] font-bold">Annual</span>
</div>
<div>
<p class="font-headline-lg text-headline-lg text-on-background mb-0.5">12</p>
...
<div>
<p class="font-headline-lg text-headline-lg text-on-background mb-0.5">1</p>
...
<div class="flex-1">
<p class="font-body-md text-body-md font-semibold text-on-background">Annual Leave</p>
<p class="font-label-sm text-label-sm text-on-surface-variant">Oct 15 - Oct 18, 2024</p>
</div>
<div class="bg-warning/10 text-warning px-2 py-1 rounded-full font-status-badge text-status-badge">
                    Pending
                </div>
</div>
</section>
...
<span class="font-label-sm text-label-sm text-on-surface-variant">June 2024</span>
</div>
